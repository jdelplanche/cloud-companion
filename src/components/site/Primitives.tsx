...
const baseBtn =
  "group stamp-press inline-flex items-center justify-center gap-2.5 rounded-[4px] border-2 border-moss bg-card px-6 py-3 font-mono text-[10px] tracking-[0.18em] text-moss uppercase transition-colors hover:bg-moss/[0.07] disabled:opacity-50";
